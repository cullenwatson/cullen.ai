  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <p className='text-[#8892b0] py-4 max-w-[700px]'>I'm an student at Southern Methodist University in Dallas, TX & graduating in May 2025, studying Computer Science and Statistics. My main interest lies in backend development, particularly designing, scaling, and maintaining service oriented architecture, particularly writing in Golang, Python & Java. Currently, I am seeking Internships in Software Engineering.
            </p>
            <div>
